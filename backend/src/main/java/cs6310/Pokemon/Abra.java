...
public class Abra extends Pokemon {
    ...
    private void setStats() {
        ...
        var attack1 = new Skill("Mega Punch", 0, 1, SkillType.ATTACK);
        var attack2 = new Skill("Mega Kick", 0, 2, SkillType.ATTACK);
        var attack3 = new Skill("Seismic Toss", 0, 3, SkillType.ATTACK);
